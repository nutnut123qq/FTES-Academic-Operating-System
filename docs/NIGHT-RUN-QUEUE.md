...
- [x] `group-create` — create group form. ✓ build xanh.
- [x] `group-challenge` — challenge rows + join. ✓ build xanh.
- [x] `group-announcement` — announcement cards. ✓ build xanh. **§7 Groups TRỌN (10 mục). QUEUE HẾT.**
