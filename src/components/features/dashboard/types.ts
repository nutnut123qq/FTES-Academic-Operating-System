 ...
 * standing); "plan" = what the viewer subscribes to (community membership + FrosTES
 * AI plans), the two money screens that used to live in profile settings. i18n labels
 * live under `dashboard.tabs.*`.
 *
