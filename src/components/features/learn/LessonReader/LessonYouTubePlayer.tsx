...
export const LessonYouTubePlayer = ({
    ...
    // Fullscreen the CONTAINER (not the YT iframe, whose native fullscreen is disabled
    ...
    return (
        <div
            ...
            className={cn(
                ...
                isFullscreen ? "flex h-full items-center rounded-none" : "aspect-video rounded-2xl",
            )}
        >
