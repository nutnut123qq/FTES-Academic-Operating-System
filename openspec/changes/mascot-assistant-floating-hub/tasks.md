...
- [x] 7.5c Số đo trình duyệt thật khớp đúng bản dựng: 412×915 → `translate 20px 57px`, `rotate -14deg`, cắt 19px phải / 51px đáy; 1280×720 → `translate 30px 85px`, `rotate -14deg`; **không sinh cuộn ngang** ở cả hai; panel nằm trọn trong màn, 8 dòng, không phải cuộn; hover-intent còn nguyên (rời 800ms còn, vào card 2,5s còn, rời hẳn 2,4s đóng)
