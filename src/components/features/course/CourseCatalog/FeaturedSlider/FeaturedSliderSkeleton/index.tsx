 ...
 * banner lines up with the catalog content below), a `min-h-[300px] rounded-2xl`
...
export const FeaturedSliderSkeleton = () => (
    <div className="flex w-full flex-col gap-3">
        <div className="flex min-h-[300px] flex-col items-center gap-5 overflow-hidden rounded-2xl bg-default p-[30px_35px] md:flex-row">
