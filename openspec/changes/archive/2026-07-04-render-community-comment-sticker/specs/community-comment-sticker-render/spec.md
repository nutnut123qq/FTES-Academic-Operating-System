...
## Purpose
Render sticker tokens produced by the community comment composer as small inline images while keeping the rest of the comment text plain and unprocessed.
