...
export interface AcademicSection {
    ...
    major: string | null
    /**
     * NGÀNH chọn từ danh mục (BE V336, mã trong `subject.majors` — vd `"SE"`), `null` = CHƯA chọn.
     * Khác {@link major} ngay trên: cái đó là chữ tự do, cái này tra được và dùng để lọc workplace.
     * Optional vì bản BE chưa deploy V336 không trả ba trường này.
     */
...
export interface ProfileUpdateRequest {
    ...
    major?: string | null
    /**
     * Mã ngành chọn từ danh mục (BE V336). `undefined`/`null` = KHÔNG ĐỔI; chuỗi RỖNG = bỏ chọn
