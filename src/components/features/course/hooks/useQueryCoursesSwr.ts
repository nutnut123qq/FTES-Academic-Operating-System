...
const fetchCoursesMock = async (): Promise<Array<Course>> => [
    ...
    { id: "swp391", code: "SWP391", name: "Đồ án phần mềm", level: "advanced", credits: 4, lessons: 16, category: "programming", rating: 4.9, ratingCount: 310, durationHours: 24, priceVnd: 1_800_000, coverUrl: "https://picsum.photos/seed/swp391/960/540", badge: "new", updatedAt: "2026-06-15", description: "Làm việc nhóm theo quy trình thực tế: từ yêu cầu, thiết kế đến bàn giao một sản phẩm phần mềm.", learnOutcomes: ["Quản lý dự án theo Scrum", "Thiết kế kiến trúc cho sản phẩm thật", "Bàn giao sản phẩm chạy được"] },
    ...
    { id: "mae101", code: "MAE101", name: "Toán cao cấp", level: "basic", credits: 3, lessons: 20, category: "math", rating: 4.6, ratingCount: 830, durationHours: 26, priceVnd: 1_000_000, coverUrl: "https://picsum.photos/seed/mae101/960/540", badge: "bestseller", updatedAt: "2026-05-15", description: "Giải tích một biến: giới hạn, đạo hàm, tích phân và ứng dụng cho các môn kỹ thuật.", learnOutcomes: ["Thành thạo đạo hàm và tích phân", "Ứng dụng giải tích vào bài toán kỹ thuật", "Nền tảng cho xác suất và AI"] },
    { id: "mas291", code: "MAS291", name: "Xác suất thống kê", level: "intermediate", credits: 3, lessons: 22, category: "math", rating: 4.5, ratingCount: 520, durationHours: 28, priceVnd: 1_100_000, coverUrl: "https://picsum.photos/seed/mas291/960/540", updatedAt: "2026-01-15", description: "Xác suất, biến ngẫu nhiên, ước lượng và kiểm định giả thuyết với ví dụ dữ liệu thật.", learnOutcomes: ["Mô hình hóa bằng biến ngẫu nhiên", "Kiểm định giả thuyết đúng cách", "Đọc hiểu kết quả thống kê"] },
