...
- Không cần seed (thuần dọn route/component FE). Smoke test redirect chạy trên deploy test
  với course seed `seed-course-c-basic` của BE change `course-demo-seed-dev`.
