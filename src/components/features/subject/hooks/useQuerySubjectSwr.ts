...
export interface Subject {
    ...
    /**
     * Mã ngành mà môn thuộc về (BE V335) — nhiều-nhiều nên là MẢNG, và rỗng có hai nghĩa gộp
     * lại: môn chưa được gắn ngành nào, hoặc BE chưa deploy V335. Bộ lọc ngành ở catalog đối
