...
Panel chấm code PHẢI cho chọn model từ `GET /api/v1/ai/models` (envelope `{code,message,data}`,
...
Bảng test case (execution — khách quan, từ Judge0) PHẢI hiển thị TÁCH BIỆT với điểm/nhận xét
...
Sau khi có kết quả, panel PHẢI có action "Chấm lại với model khác" mở lại model picker.
...
Chấm đồng bộ 10–60s. Panel PHẢI hiển thị progress ("Đang chạy test case…" → "Đang chấm bằng
