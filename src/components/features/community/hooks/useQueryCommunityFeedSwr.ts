...
const fetchFeedMock = async (): Promise<Array<CommunityPost>> => [
    { id: "cp1", author: "Minh Trần", timeLabel: "1 giờ trước", title: "Chia sẻ lộ trình học Backend", snippet: "Mình tổng hợp lộ trình 6 tháng từ con số 0…", likes: 42, liked: false, comments: 12 },
    { id: "cp2", author: "An Nguyễn", timeLabel: "3 giờ trước", title: "Hỏi về đồ án SWP391", snippet: "Nhóm mình đang phân vân chọn đề tài, mọi người tư vấn với…", likes: 8, liked: false, comments: 5 },
    { id: "cp3", author: "Hoa Lê", timeLabel: "hôm qua", title: "Khoe chứng chỉ AWS đầu tiên", snippet: "Sau 2 tháng ôn cuối cùng cũng pass, cảm ơn cộng đồng…", likes: 130, liked: true, comments: 24 },
]
