 ...
 * reading column capped at 620px (Threads' column width); from `xl` two sticky
 * rails flank it — NavRail (shortcuts) left, DiscoveryRail (trending · uy tín ·
 * quick poll) right — both absent below `xl`. ponytail: mock data.
 */
