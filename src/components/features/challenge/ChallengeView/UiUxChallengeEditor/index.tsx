            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:grid-rows-[auto_auto]">
                ...
                >
                    ...
                    {challenge.isLocked ? (
                        <div className="absolute inset-0 z-10 flex items-center justify-center rounded-large bg-background/70 p-6">
                            <div className="flex max-w-sm flex-col items-center gap-3 rounded-large border border-separator bg-surface p-6 text-center">
                                <LockIcon
                ...
                >
                    ...
                    <iframe
                        ...
                        className="h-[320px] w-full rounded-large border border-separator bg-white lg:h-[360px]"
                    />
                </div>
