            ...
            {sources.length === 0 ? (
                ...
                <div className="flex flex-col items-center gap-3">
                    <button
                        ...
                        className="flex min-h-48 w-full flex-col items-center justify-center gap-2 rounded-2xl border border-separator p-6 text-center outline-none transition-colors hover:bg-default focus-visible:ring-2 focus-visible:ring-focus"
                    >
