...
const MentorCard = ({ mentorKey, avatarUrl }: { mentorKey: string; avatarUrl: string }) => {
    ...
    return (
        <article className="flex min-w-[16rem] max-w-xs shrink-0 snap-start flex-col gap-4 rounded-large border border-separator bg-surface p-6 sm:min-w-0 sm:max-w-none">
