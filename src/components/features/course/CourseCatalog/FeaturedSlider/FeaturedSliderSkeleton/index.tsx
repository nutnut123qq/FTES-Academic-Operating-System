 ...
 * shape per the house skeleton rule: the same centred `max-w-[1200px] px-[30px]`
 * container, a `min-h-[300px] rounded-[20px]` card with a LEFT copy column (title +
 * pitch bars + pill CTA) and a RIGHT image box at `md:`, and a LEFT-aligned dot row.
 * Built on the HeroUI Skeleton primitive.
 */
export const FeaturedSliderSkeleton = () => (
    <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-3 px-[30px]">
