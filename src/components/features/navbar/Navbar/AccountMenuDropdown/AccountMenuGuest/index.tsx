...
/**
 * Account dropdown menu for SIGNED-OUT viewers: sign in + sign up, each opening the
 * authentication modal on its tab. The "Khám phá" (Explore) section is gone — its
 * last row was the AI assistant, which now lives in the floating mascot at the
 * bottom-right of every page. Self-contained; takes no data props.
 *
