...
/**
 * CartButton — navbar shopping-cart icon that links to `/cart` and shows a badge
 * with the number of items in the viewer's cart.
 *
 ...
 * `"use client"` for the SWR hook + navigation.
