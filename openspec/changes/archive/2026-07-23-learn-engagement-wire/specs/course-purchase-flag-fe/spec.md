...
- Không seed FE. Verify trên BE seed `course-demo-seed-dev`: purchase demo
  `seed-purchase-demo-java` (account test student) trên package `seed-pack-java-full`.
